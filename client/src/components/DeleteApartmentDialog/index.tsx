...
const DeleteApartmentDialog = ({
  ...
  return (
    <Dialog open={true}>
      <DialogTitle bgcolor={'#f44336'} color={'white'}>
        Delete Apartment
      </DialogTitle>
      <DialogContent>
        <DialogContentText sx={{ padding: 1, color: 'black' }}>
          Are you sure you want to delete {apartmentDetails.city}, {apartmentDetails.street}{' '}
          {apartmentDetails.houseNumber}?
        </DialogContentText>
      </DialogContent>
      <DialogActions>
        <Button onClick={handleClose}>Cancel</Button>
        <Button variant='contained' color='error' onClick={handleDeleteApartment}>
          Delete
        </Button>
      </DialogActions>
    </Dialog>
