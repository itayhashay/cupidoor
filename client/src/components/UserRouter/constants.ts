...
export const PROFILE_STEPS = (user: User) => [
  {
    ...
    description:
      "Make sure your user information are correct so people could contact you.",
    icon: BasicInfoIcon,
    validCheck: () => {
      return true;
    },
  },
  {
    ...
    description:
      "Answering lifestyle questions can find better matches for you.",
    icon: QuestionsIcon,
    validCheck: () => {
  ...
  },
  {
    ...
    description:
      "A profile picture, job title and a short description of yourself will complete the information about you to people.",
    icon: CardIcon,
    validCheck: () => {
      return user.avatar && user.jobTitle && user.description ? true : false; // TODO: Change true to profile picture
    },
  },
  {
    name: PROFILE_STEPS_KEYS.SOCIAL_MEDIA,
    description:
      "Adding social media links gives people more information about you.",
